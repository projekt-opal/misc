...
public class Main {
	...
	private void createRdf(List<DatasetContainer> containers, File turtleFile) throws IOException {
		Model model = new Rdf().create(containers);
		System.out.println("Writing: " + turtleFile.getAbsolutePath());
		FileOutputStream fileOutputStream = new FileOutputStream(turtleFile);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append("# MDM Mobility Data Marketplace\n");
		stringBuilder.append("# https://www.mdm-portal.de/\n\n");
		stringBuilder.append("# RDF data generated by OPAL at DICE\n");
		stringBuilder.append("# http://projekt-opal.de/\n");
		stringBuilder.append("# https://dice-research.org/\n\n");
		fileOutputStream.write(stringBuilder.toString().getBytes());
		RDFDataMgr.write(fileOutputStream, model, Lang.TURTLE);
	}
}